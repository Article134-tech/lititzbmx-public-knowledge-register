...
<header class="site-header"><div class="masthead"><a class="brand-mark" href="{internal()}" aria-label="Lititz BMX Public BMX Knowledge Register home"><img src="{internal('assets/'+LOGO)}" width="446" height="532" alt="Lititz BMX"></a><div class="masthead-copy"><p class="brand-eyebrow">Lititz BMX</p><p class="product-title">Public BMX Knowledge Register</p><p class="release-line">Ephemera v1.2.0 · Final 500-record release · Data locked August 1, 2026</p></div></div></header>{nav}<main id="main-content" tabindex="-1">{breadcrumbs(crumbs or [])}{body}</main>
...
body=f'<section class="hero"><p class="kicker">Resources</p><h1>Downloads</h1><p>Release workbooks, authoritative sequence package, and checksums.</p><div class="actions"><a class="button button-secondary" href="{REPO_URL}/blob/main/RELEASE_NOTES_v1.2.0.md" target="_blank" rel="noopener noreferrer">Read the v1.2.0 release notes</a></div></section>{filter_controls("downloads-table","downloads",len(frows),"Search file name or type")}{table(frows,["File","Type","Bytes","Download"],"downloads-table","Downloads")}'
